...
const PrizeCard = ({ prize, index, inView }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative p-6 md:p-8 border ${prize.borderColor} rounded-lg bg-card/50 backdrop-blur-sm ${prize.glowColor} hover:scale-105 transition-all duration-300`}
      >
        {/* Decorative corners */}
